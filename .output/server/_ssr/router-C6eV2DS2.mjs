...
import { a as Truck, l as SprayCan, r as Wrench, s as Trees, u as Snowflake } from "../_libs/lucide-react.mjs";
import { n as clsx, t as cva } from "../_libs/class-variance-authority+clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { r as router_exports } from "./router-C6eV2DS22.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/site-DvkBA11K.js
...
var transport_van_default = "/assets/transport-van-gLz0_lVS.jpeg";
var COMPANY = {
	name: "DHANSA",
...
var PHOTO_ASSETS = {
	...
	transportVan: transport_van_default
};
var SERVICES = [
	{
		id: "umzug",
	...
	},
	{
		...
		description: "Wir übernehmen Transporte zuverlässig und flexibel – für Unternehmen, Gewerbekunden und öffentliche Auftraggeber. Mit erfahrenem Personal und passenden Transportfahrzeugen sorgen wir für eine termingerechte Abwicklung in Hamburg und Umgebung.",
		items: [
...
var CAREER_OPENINGS = [
	{
		...
		location: "Hamburg",
		pay: "ab 15,00 €/Std.",
		summary: "Verantwortung für sichere Transporte, zuverlässige Lieferungen und professionelle Kundenbetreuung in Hamburg und Umgebung.",
		requirements: [
	...
	},
	{
		...
		location: "Hamburg",
		pay: "ab 14,50 €/Std.",
		summary: "Sorgfältiger Umgang mit Möbeln, Verpackung und Organisation von Umzügen für Privat- und Gewerbekunden.",
		requirements: [
	...
	},
	{
		...
		location: "Hamburg",
		pay: "ab 14,50 €/Std.",
		summary: "Selbstständige und gründliche Arbeit in Büros, Praxisräumen, Gebäuden und Gewerbeobjekten.",
		requirements: [
	...
	},
	{
		...
		location: "Hamburg",
		pay: "ab 19,00 €/Std.",
		summary: "Verantwortung für die IT-Infrastruktur, Systemadministration und technische Unterstützung im Unternehmen.",
		requirements: [
	...
	},
	{
		...
		location: "Hamburg",
		pay: "ab 14,00 €/Std.",
		summary: "Wartung, Kontrolle und zuverlässige Umsetzung von Außen- und Winterdienstaufgaben an verschiedenen Objekten.",
		requirements: [
...
var JOBS = CAREER_OPENINGS.map(({ title, location, pay }) => ({
	title,
	location,
	pay
}));
...
//#endregion
export { CAREER_PROCESS as a, JOBS as c, SERVICES as d, STATS_HERO as f, cn as h, CAREER_OPENINGS as i, PHOTO_ASSETS as l, TRUST as m, Button as n, COMPANY as o, TESTIMONIALS as p, CAREER_BENEFITS as r, FAQS as s, router_exports as t, PROCESS as u };
